...
The full set of 256 prompts, with their identifiers, is in the file \texttt{data/api/prompts\_2026-08-14.json} in the analysis folder.
...
For analysis, we focused on a subsample of data that was coded. The coding sample holds every complete API answer and 100 web captures per prompt and collection day, drawn at random: 103,934 answers in total. The coder labelled 102,247 of them; 1,687 (1.6\%) failed the coder's own evidence checks after four passes and are shown as ``not coded''. They lean toward advice, so the narrow rates for the most permissive models are lower bounds.
