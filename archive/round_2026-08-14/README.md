...
The design contains five information conditions (L2 and L3 are separate branches).
...
- party_scales.json: Zucco-Power (2024) and Bolognesi et al. (2023) party positions, used to place a recommendation on a left-right ruler.
...
The unified API/web pipeline is in `../analysis/`. Its README defines current outcomes, weighting, validation and interpretation. All derived results live in `../output/`; this collection folder retains raw archives and design inputs only.
